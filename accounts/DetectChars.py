...
classification = os.path.join(module_dir, 'classifications.txt')
flattened_images = os.path.join(module_dir, 'flattened_images.txt')
...
def loadKNNDataAndTrainKNN():
    ...
    try:
        npaClassifications = np.loadtxt(classification, np.float32)                  # read in training classifications
